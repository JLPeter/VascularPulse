...
if "must_reload" not in st.session_state:
    st.session_state.must_reload = False
...
if ctx.video_processor:
    if st.session_state.must_reload:
        status_placeholder.error("Please reload the app before using this tool again.")
    else:
        ...
        while True:
            try:
                ...
                st.session_state.must_reload = True
                status_placeholder.error("Please reload the app before using this tool again.")
                break
